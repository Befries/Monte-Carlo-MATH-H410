...
def simulate_transport(capture_scattering_ratio, sigma_total, wall_thickness, population_size, split_factor, threshold):
    ...
    :param capture_scattering_ratio: ratio between the proba of scattering and proba of capture
    :param sigma_total: proba of any interaction per unit length
    :param wall_thickness: wall thickness
    :param population_size: number of neutrons
    :param split_factor: split factor
    :param threshold: threshold for the russian roulette
    :return:
    """
