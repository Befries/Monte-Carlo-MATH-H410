...
from NeutronTransport2 import simulate_transport
...
def test_split():
    ...
    print("all simulation run in", total_time, "seconds")
    fig, axs = plt.subplots(2)
    axs[0].scatter(split_range, variances)
    ...
    color = 'tab:red'
    axs[1].plot(split_range, efficiency, color=color)
